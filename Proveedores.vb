...
Public Class Proveedores
    ...
    Sub buscar(ByVal condicion As String)
        ...
        Dim da As New SqlDataAdapter("SELECT TOP (100) PERCENT nprov, apellido from [ABM].[dbo].[Proveedores] where " & condicion & " order by apellido", con)
    ...
    Sub CargarCamposProveedores()
        ...
        Else
            ...
            TextBox10.Text = ds.Tables("Proveedores").Rows(0)("usuario")
            TextBox11.Text = ds.Tables("Proveedores").Rows(0)("clave")
        End If
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If MessageBox.Show("Está por ELIMINAR definitivamente al Proveedor: " & TextBox1.Text.Trim.ToUpper & ", " & TextBox12.Text.Trim.ToUpper & ". Es algo EXTREMO, porque se perderán las referencias. Está SEGURO?", "Eliminar Proveedor", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then Exit Sub

        If SQL_Accion("delete from [ABM].[dbo].[Proveedores]  where  nprov=" & Val(lLegajo.Text)) = False Then
    ...
    Private Sub bNuevoProveedor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bNuevoProveedor.Click
        If SQL_Accion("insert into [ABM].[dbo].[Proveedores] (apellido, nombre, [documento],domicilio, localidad, teléfono, fechanacimiento, comentarios,[email],estado, cuit, usuario, clave) values ('**','**',                  0,           '',           '',             '',           getdate(),               ''       ,      ''    ,     1 , '', '', ''  )  ") Then
