...
Public Class Clientes
    ...
    Sub buscar(ByVal condicion As String)
        ...
        Dim da As New SqlDataAdapter("SELECT TOP (100) PERCENT NCli, apellido from [ABM].[dbo].[Clientes] where " & condicion & " order by apellido", con)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If MessageBox.Show("Está por ELIMINAR definitivamente al Cliente: " & TextBox1.Text.Trim.ToUpper & ", " & TextBox12.Text.Trim.ToUpper & ". Es algo EXTREMO, porque se perderan las referencias. Está SEGURO?", "Eliminar Cliente", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then Exit Sub

        If SQL_Accion("delete from [ABM].[dbo].[Clientes]  where  ncli=" & Val(lLegajo.Text)) = False Then
    ...
    Private Sub bNuevoCliente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bNuevoCliente.Click
        If SQL_Accion("insert into [ABM].[dbo].[Clientes] (apellido, nombre, [documento],domicilio, localidad, teléfono, fechanacimiento, comentarios,[email],estado, cuit, usuario, clave) values ('*****','*****',                  0,           '',           '',             '',           getdate(),               ''       ,      ''    ,     1 , '', '', ''  )  ") Then
